    ...
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-6">
          ...
          <input type="file" name="" id="images" onChange={onChange} accept='.jpg,.png,.jpeg' multiple className='w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out  focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
        </div>
